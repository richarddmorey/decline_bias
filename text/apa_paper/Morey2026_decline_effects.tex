...
All code to reproduce this paper can be found at \url{https://github.com/richarddmorey/decline_bias}.
This draft was compiled Monday 09 Feb 2026 at 11:24:40 GMT.
...
Coining is also used in the study of decline effects. In this context, the sign of the effect of an initial study (the earliest one in the set, often the first to report the effect in question) is flipped to be positive, and then all subsequent studies are re-aligned to be consistent with that direction (e.g. Fanelli, Costas, \& Ioannidis, 2017; Gong \& Jiao, 2019; {Nuijten, van Assen, Augusteijn, Crompvoets, \& Wicherts}, 2020; Pietschnig et al., 2019). For instance, Fanelli et al. (2017) report in their methods that:
...
\noindent and reported a ``substantial decline'' (p.~943) in effect sizes from original to replication (see also e.g. Camerer et al., 2018; Errington et al., 2021).
